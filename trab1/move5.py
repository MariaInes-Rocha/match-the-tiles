...
board=[[3,3,3,3,3,3,3],[3,2,0,1,3,1,3],[3,2,3,0,0,0,3],[3,3,3,0,0,0,3],[3,0,0,0,0,0,3],[3,3,0,3,0,0,3],[3,3,3,3,3,3,3]]
class peca1:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_UP:
                    ...
                    peca_1.x, peca_1.y = 0, 2
                    peca_2.x, peca_2.y = 0, 4
                    board_reset()
...
def bfs(board, start, objetivo):
    ...
    return None, "Não há dica disponível"
