...
board=[[3,3,3,3,3,3],[3,0,0,0,2,3],[3,0,3,3,2,3],[3,0,3,0,0,3],[3,1,3,1,0,3],[3,3,3,3,3,3]]
class peca1:
...
def desenhar_tabuleiro(tela, TAMANHO_TABULEIRO):
    for i in range(1, 5):
        pygame.draw.line(tela, PRETO, (i * TAMANHO_TABULEIRO // 4, 0), (i * TAMANHO_TABULEIRO // 4, TAMANHO_TABULEIRO))
